...
data = pd.read_excel("/home/ljy/tactile_reconstruction/code/0_creat_data_set/data_df_test.xls", "Sheet1")
pic = []
param = []
...
writer = pd.ExcelWriter("/home/ljy/tactile_reconstruction/code/2generate_train_test_dataset/test_circles_vpaper.xls")
test_pic_file_root = "/home/ljy/tactile_reconstruction/code/pic_data_set/for_test/"
train_pic_file_root = "/home/ljy/tactile_reconstruction/code/pic_data_set/for_train/"
for picture, parameter in zip(pic,param):
    number = f"{picture:>05}"
    name = test_pic_file_root + number + ".png"
    # print(name)
    img = cv2.imread(name)
